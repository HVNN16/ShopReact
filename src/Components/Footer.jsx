			...
			<div className="container justify-center text-center px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
				...
				<div className=" justify-center text-center pt-4 lg:justify-between">
					...
					<div className='flex flex-row sm:items-auto justify-center text-center py-3 lg:items-auto gap-3'>
						...
						<a target='blank' href="/"><button className='border border-[#FF6600]/80 rounded-full py-1 px-4 hover:bg-[#FF6600]/80 transition duration-300 easeinout'>Linkedin</button></a>
						<a target='blank' href="/"><button className='border border-[#FF6600]/80 rounded-full py-1 px-4 hover:bg-[#FF6600]/80 transition duration-300 easeinout'>Github</button></a>
						<a target='blank' href="/"><button className='border border-[#FF6600]/80 rounded-full py-1 px-4 hover:bg-[#FF6600]/80 transition duration-300 easeinout'>Twitter</button></a>

						<a target='blank' href="/"><button className='border border-[#FF6600]/80 rounded-full py-1 px-4 hover:bg-[#FF6600]/80 transition duration-300 easeinout'>Facebook</button></a>
